...
// const ChatArea = () => {
//     const { user } = useAuth();
//     const { activeConversation, messages, typingUsers, onlineUsers, loadMessages, setMessages } = useChat();
//     const [activeCall, setActiveCall] = useState(null);
//     const [incomingCall, setIncomingCall] = useState(null);
//     const [showMoreMenu, setShowMoreMenu] = useState(false);
//     const [isMuted, setIsMuted] = useState(false);
...
// const ChatArea = () => {
//     const { user } = useAuth();
//     const { activeConversation, messages, typingUsers, onlineUsers, loadMessages, setMessages, setConversations } = useChat();
//     const [activeCall, setActiveCall] = useState(null);
//     const [incomingCall, setIncomingCall] = useState(null);
//     const [showMoreMenu, setShowMoreMenu] = useState(false);
//     const [isMuted, setIsMuted] = useState(false);
...
//                 // Update sidebar - set last message to empty
//                 setConversations(prev =>
//                     prev.map(conv =>
//                         conv._id === activeConversation._id
//                             ? {
//                                 ...conv,
//                                 lastMessage: { content: 'No messages', createdAt: new Date() },
