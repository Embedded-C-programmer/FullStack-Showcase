...
// @route   PUT /api/auth/vendor-info
// @access  Private (Vendor only)
exports.updateVendorInfo = async (req, res, next) => {
    try {
        ...
        const user = await User.findByIdAndUpdate(
            req.user.id,
            {
                ...
                'vendorInfo.businessDescription': businessDescription,
                'vendorInfo.businessAddress': businessAddress
            },
            {
                new: true,
                runValidators: true
