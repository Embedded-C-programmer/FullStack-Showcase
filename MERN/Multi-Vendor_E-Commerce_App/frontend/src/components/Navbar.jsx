...
import { FaShoppingCart, FaUser, FaBars, FaTimes, FaMoon, FaSun, FaStore, FaHeart } from 'react-icons/fa';
                    ...
                    <div className="hidden md:flex items-center space-x-6">
                        ...
                        {isAuthenticated ? (
                            <>
                                ...
                                <Link to="/wishlist" className="relative text-gray-700 dark:text-gray-200 hover:text-red-500 dark:hover:text-red-400 transition">
