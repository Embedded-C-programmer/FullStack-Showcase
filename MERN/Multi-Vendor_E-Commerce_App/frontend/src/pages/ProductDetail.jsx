        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
                ...
                <div>
                    ...
                    <div className="mb-6">
                        <Link to={`/vendor/${product.vendor._id}`} className="flex items-center text-gray-700 hover:text-blue-600">
                    ...
                    <div className="grid grid-cols-3 gap-4 mt-6 pt-6 border-t">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-xs text-gray-600">Trusted Vendor</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        {product.specifications.map((spec, index) => (
                            <div key={index} className="flex border-b py-2">
                                <span className="font-semibold w-1/3">{spec.key}:</span>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-8">
                ...
                {/* Add Review Form */}
                {isAuthenticated && (
                    <form onSubmit={handleReviewSubmit} className="mb-8 p-4 bg-gray-50 rounded">
